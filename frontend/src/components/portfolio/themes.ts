...
export const themes: Theme[] = [
  ...
  // ─── BUSINESS (الجديدة) ───
  {
    ...
    name: "Cosmos",
    plan: "BUSINESS",
    preview: "linear-gradient(135deg, #0a0a0a, #1a0533, #2d0a6b)",
    colors: {
      primary: "#a855f7",
      accent: "#c084fc",
      background: "#05030f",
  ...
  },
  {
    ...
    name: "Ember",
    plan: "BUSINESS",
    preview: "linear-gradient(135deg, #1a0a00, #3d1a00, #7a3800)",
    colors: {
      primary: "#f97316",
      accent: "#fb923c",
      background: "#0c0500",
  ...
  },
  {
    ...
    name: "Ivory",
    plan: "BUSINESS",
    preview: "linear-gradient(135deg, #f8f6f0, #ede8da, #d4c9b0)",
    colors: {
      primary: "#92400e",
      accent: "#b45309",
      background: "#faf8f2",
  ...
  },
  {
    ...
    name: "Navy",
    plan: "BUSINESS",
    preview: "linear-gradient(135deg, #0a1628, #0d2545, #1a3a6b)",
    colors: {
      primary: "#93c5fd",
      accent: "#60a5fa",
      background: "#06101e",
  ...
  },
  {
    ...
    name: "Carbon",
    plan: "BUSINESS",
    preview: "linear-gradient(135deg, #1a1a1a, #2d2d2d, #404040)",
    colors: {
      primary: "#e5e5e5",
      accent: "#ffffff",
      background: "#111111",
