  ...
  return (
    <div className="bg-white dark:bg-gray-900 p-8 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-800 w-full max-w-md text-center">
      ...
      {status === 'error' && (
        <>
          <div className="text-4xl mb-4">❌</div>
          <h1 className="text-xl font-semibold text-gray-900 dark:text-white mb-2">Invalid or expired link</h1>
          <p className="text-gray-500 text-sm mb-4">Please register again or contact support.</p>
          <a href="/register" className="text-indigo-600 hover:underline text-sm">Go to Register</a>
        </>
      )}
    </div>
  )
