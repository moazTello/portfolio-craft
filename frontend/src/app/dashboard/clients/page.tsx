    ...
    return (
      <div className="bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 rounded-xl p-12 text-center">
        ...
        <p className="text-gray-400 text-sm mb-6">
          Showcase the companies and clients you've worked with.
        </p>
        <a
      ...
      {clients.length === 0 ? (
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-3">
          {clients.map((client) => (
            <div
              key={client.id}
              className="bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 rounded-xl p-4 text-center group relative flex flex-col items-center"
            >
              {/* Logo */}
              <div className="w-14 h-14 mb-3 flex items-center justify-center rounded-xl overflow-hidden bg-gray-50 dark:bg-gray-800">
                {client.logoUrl ? (
                  <img
                    src={client.logoUrl}
                    alt={client.name}
              ...
              <div className="absolute inset-0 bg-black/0 group-hover:bg-black/5 dark:group-hover:bg-white/5 rounded-xl transition flex items-center justify-center gap-2 opacity-0 group-hover:opacity-100">
                <button
                  ...
                  className="bg-white dark:bg-gray-800 text-xs text-gray-700 dark:text-gray-300 px-2 py-1 rounded-lg shadow"
                >
                  Edit
                </button>
                <button
